...
function listenForDownloadHeaders (ses) {
  ses.webRequest.onHeadersReceived(function (details, callback) {
    ...
    */
    if (details.webContents && (details.webContents.getURL().startsWith('useful://app/pages/pdfViewer') || details.webContents.getURL().startsWith('useful://app/reader/') || details.webContents.getURL() === 'useful://app/index.html')) {
      ...
      callback({
        responseHeaders: {
          ...filteredHeaders,
          'Access-Control-Allow-Origin': 'useful://app',
